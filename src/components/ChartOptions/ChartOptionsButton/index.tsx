...
export default function ChartOptionsButton({ position, selectedPosition, setSelectedPosition, handleBB }: ChartOptionsButtonProps) {

    function handleSelection(selected: string) {
        selected === "BB" && handleBB ? handleBB("vs RFI UTG") : handleBB && handleBB("RFI");
